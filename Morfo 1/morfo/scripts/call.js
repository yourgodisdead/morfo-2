...
window.fw_menu_1 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#F7B67F","#084A37");
  fw_menu_1.addMenuItem("Introducción","location='../Seminario-2/introduccion.htm'");
  fw_menu_1.addMenuItem("Objetivos","location='../Seminario-2/objetivos.htm'");
  fw_menu_1.addMenuItem("Sumario","location='../Seminario-2/sumario.htm'");
  fw_menu_1.addMenuItem("Preparación","location='../Seminario-2/preparacion.htm'");
  fw_menu_1.addMenuItem("Consulta Docente","location='../Seminario-2/consulta.htm'");
  fw_menu_1.addMenuItem("Autoevaluación","location='../Seminario-2/autoevaluacion.htm'");
  fw_menu_1.fontWeight="bold";
   fw_menu_1.hideOnMouseOut=true;

  window.fw_menu_2 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#F7B67F","#084A37");
    fw_menu_2.addMenuItem("Técnica","location='../Práctica-2/tecnicasdelaboratorio.htm'");
	fw_menu_2.addMenuItem("Autopreparación","location='../Práctica-2/autopreparacion.htm'");
  fw_menu_2.addMenuItem("Procedimiento","location='../Práctica-2/procedimiento.htm'");
  fw_menu_2.addMenuItem("Problema","location='../Práctica-2/problema.htm'");  
  fw_menu_2.fontWeight="bold";
  fw_menu_2.hideOnMouseOut=true;

    window.fw_menu_3 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#F7B67F","#084A37");
    
  fw_menu_3.addMenuItem("Procedimiento","location='../Practica-1/procedimiento.htm'");
  fw_menu_3.addMenuItem("Problema","location='../Practica-1/problema.htm'");  
  fw_menu_3.fontWeight="bold";
  fw_menu_3.hideOnMouseOut=true;
  
 window.fw_menu_4 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#F7B67F","#084A37");
    fw_menu_4.addMenuItem("Técnica","location='../Práctica-2/tecnicasdelaboratorio.htm'");
  fw_menu_4.addMenuItem("Autoevaluación","location='../Práctica-2/autoevaluación.htm'");
  fw_menu_4.addMenuItem("Procedimiento","location='../Práctica-2/procedimiento.htm'");
  fw_menu_4.addMenuItem("Problema","location='../Práctica-2/problema.htm'");  
  fw_menu_4.fontWeight="bold";
  fw_menu_4.hideOnMouseOut=true;
   
  window.fw_menu_5 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#3A7A4A","#084A37");
  ...
  window.fw_menu_6 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#3A7A4A","#084A37");
  ...
  window.fw_menu_7 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#3A7A4A","#084A37");
 ...
 window.fw_menu_8 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#3A7A4A","#084A37");
 ...
 window.fw_menu_9 = new Menu("root",160,22,"Verdana, Arial, Helvetica, sans-serif",10,"#000000","#EDD3B5","#3A7A4A","#084A37");
